...
function buildQuiz() {
  ...
  const output = [];
  // for each question...
  _body.myQuestions.forEach((currentQuestion, questionNumber) => {
...
function showResults() {
  ...
  resultsContainer.innerHTML = `${numCorrect} out of ${_body.myQuestions.length}`;
}
...
},{"./body":"Spvay"}],"Spvay":[function(require,module,exports) {
