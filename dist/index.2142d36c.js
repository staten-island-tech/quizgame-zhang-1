...
function buildQuiz() {
  ...
  const output = [];
  // for each question...
  _bodyJs.myQuestions.forEach((currentQuestion, questionNumber) => {
...
function showResults() {
  ...
  resultsContainer.innerHTML = `${numCorrect} out of ${_bodyJs.myQuestions.length}`;
}
...
},{"./body.js":"Spvay"}],"Spvay":[function(require,module,exports) {
...
let myQuestions = [{
  ...
  question: "Where is this line from: I came home on Tuesday and found all of the chairs that I own stacked in a tower in the center of my kitchen.",
  answers: {
    a: "a novel",
    b: "a movie",
    c: "a poem",
